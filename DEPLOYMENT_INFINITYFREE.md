...
- **For the backend API:** use a host that does not modify responses. **No credit card needed:** **[Koyeb](DEPLOYMENT_KOYEB.md)** or **[Fly.io](DEPLOYMENT_FLYIO.md)**. (Render requires a card.)
